  ...
  return (
    <Container className={styles.logWorkoutContainer}>
      ...
      <form onSubmit={handleSubmit} className={styles.form}>
        ...
        <TextField label="Duration (min)" name="duration" value={form.duration} onChange={handleInputChange} fullWidth margin="normal" required type="number" />
        <TextField label="Calories Burned" name="calories" value={form.calories} onChange={handleInputChange} fullWidth margin="normal" required type="number" />
        <TextField label="Date" name="date" value={form.date} onChange={handleInputChange} fullWidth margin="normal" required type="date" />

        <FormControl fullWidth margin="normal" required>
          <InputLabel>Intensity Level</InputLabel>
          <Select name="intensity" value={form.intensity} onChange={handleSelectChange}>
        ...
        <TextField label="Notes (Optional)" name="notes" value={form.notes} onChange={handleInputChange} fullWidth margin="normal" multiline rows={3} />
